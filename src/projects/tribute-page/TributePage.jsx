...
class TributePage extends PureComponent {
  ...
  render() {
    return (<div className={this.classnames('tribute-page')}>
      ...
      <section className={this.classnames('tribute-page__media')}>
        <iframe
          className={this.classnames('tribute-page__video', {
      ...
      <section className={this.classnames('tribute-page__supporting-text')}>
        {this.props.error || (<ul className={this.classnames({ 'tribute-page__quotes': true, 'tribute-page__quotes--hidden': !this.props.loaded })}>
          {this.props.quotes.map((quote, index) => {
            const k = index;
            return (<li key={k} className={this.classnames('tribute-page__quote')}>{quote}</li>);
          })}</ul>)}
      </section>
    </div>);
  }
...
TributePage.childContextTypes = { classnames: func.isRequired };
