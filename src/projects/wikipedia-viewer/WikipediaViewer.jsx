...
class WikipediaViewer extends PureComponent {
  ...
  render() {
    return (<div className={this.classnames('wikipedia-viewer')}>
      <SearchBar className={this.classnames('wikipedia-viewer__header')} noValidate onSubmit={this._handleSubmit} onChange={this.props.onChange} onBlur={this.props.onBlur} onFocus={this.props.onFocus} error={this.props.error} submitting={this.props.submitting} active={this.props.active} value={this.props.value} />

      <section className={this.classnames('wikipedia-viewer__random')}>
      ...
      <ul className={this.classnames('wikipedia-viewer__results')}>
...
WikipediaViewer.childContextTypes = { classnames: func.isRequired };
