    ...
    return (<form onSubmit={this.handleSumbit} className={className}>
      ...
      <section className="image">
        <label htmlFor="picture">
          Image
          {picture && (<a role="button" tabIndex="0" className="material-icons delete" title="remove picture" onClick={this.deleteImage}>close</a>)}
        </label>
        <input
          name="picture"
          type="file"
        ...
        ) ? (<img alt="preview" src={picture} />) : (<canvas width="0" height="0" ref={(canvas) => { this.canvas = canvas; }} ></canvas>)}</section>
      </section>
